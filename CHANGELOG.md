...
## 1.6.0 (2025/06/16)
* Improve: Include fix by @haensen for current mermaid - #365(https://github.com/yzane/vscode-markdown-pdf/pull/365)
* Change: publish as clone on VS Code Marketplace
